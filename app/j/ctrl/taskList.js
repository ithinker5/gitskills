...
$(function () {
  ...
  function getTasks() {
    service.getTasks({department_id: department_id,type:0}, res => {
      ...
      $('#accountTable1').dataTable({
        ...
        data: res,
        columns: [{data: 'num', title: '序号', orderable: true,bSortable:true},
          {data: 'title', title: '任务名称', orderable: true,bSortable:true},
          {data: 'leader_grade', title: '最低岗位级别', orderable: true,bSortable:true},
          {data: 'base_vc', title: 'VC', orderable: true,bSortable:true},
          {data: 'gold', title: '金币', orderable: true,bSortable:true},
          {data: 'exp', title: '经验值', orderable: true,bSortable:true},
          {data: 'subtype2', title: '任务类型', orderable: true,bSortable:true},
          {data: 'level', title: '任务等级', orderable: true,bSortable:true},
          {data: 'status2', title: '任务状态', orderable: true,bSortable:true},
