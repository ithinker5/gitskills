$(function () {
  ...
  function dateChange(date) {
    ...
    let result = `${newDate.getFullYear()}<span style="position: relative;top: -3.9px;">-</span>${newDate.getMonth()+1}<span style="position: relative;top: -3.9px;">-</span>${newDate.getDate()}`;
    return result
  }
  //获取url参数
