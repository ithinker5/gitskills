...
$(function () {
  ...
  function getBlackList() {
    service.getBlackList(function (res) {
      ...
      $('#accountTable1').dataTable({
        ...
        data: res,
        columns: [{ data: 'num', title: '排名', orderable: false }, { data: 'name', title: '姓名', orderable: false }, { data: 'factionName', title: '所在帮会', orderable: false }, { data: 'gold', title: '总金币', orderable: false }]
      });
