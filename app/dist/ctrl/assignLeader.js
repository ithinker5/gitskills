...
$(function () {
  ...
  var maxGrade = window.sessionStorage.getItem('grade');
  ...
  var returnPage = getUrlParam('returnPage');
  var id = getUrlParam('taskId');
  var selectId = '';
  var selectLeaderName = '';
  var selectLeaderGold = '';
  ...
  function getLeaders() {
    ...
    var pitchTeams = getUrlParam('pitchTeams');
    var obj = { maxGrade: maxGrade };
    ...
    service.getLeadersFilter(obj, function (res) {
      ...
      $('#accountTable1').dataTable({
        ...
        data: res,
        columns: [{ data: 'num', title: '序号', orderable: true }, { data: 'name', title: '队伍名称', orderable: true }, { data: 'member_count', title: '队伍人数', orderable: true }, { data: 'created.name', title: '领队', orderable: true }, { data: 'created.worker_number', title: '工号', orderable: true }, { data: 'leader_grade', title: '领队评分', orderable: true }, { data: 'grade', title: '等级', orderable: true }, { data: 'job_name', title: '岗位名称', orderable: true }, { data: 'job_grade', title: '岗位级别', orderable: true }, { data: 'grade', title: 'f', orderable: false }]
      });
