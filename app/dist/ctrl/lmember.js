  ...
  function getList() {
    service.getList(function (res) {
      ...
      $('#accountTable1').DataTable({
        ...
        data: res,
        columns: [{ data: 'num', title: '序号', orderable: true }, { data: 'name', title: '姓名', orderable: true }, { data: 'grade', title: '岗位级别', orderable: true }, { data: 'level', title: '等级', orderable: true }, { data: 'factions2', title: '所属帮会', orderable: true }, { data: 'role_id2', title: '帮会职务', orderable: true }]
      });
