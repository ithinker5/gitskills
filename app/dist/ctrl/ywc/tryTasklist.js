...
$(function () {
  ...
  function getPersonalTask() {
    service.getPersonalTask({ type: 3 }, function (res) {
      ...
      $('#accountTable1').dataTable({
        ...
        data: res,
        columns: [{ data: 'num', title: '序号', orderable: true }, { data: 'title', title: '任务名称', orderable: true }, { data: 'type', title: '任务类型', orderable: true }, { data: 'status2', title: '任务状态', orderable: true }, { data: 'created.name', title: '发布人', orderable: true }, { data: 'leader2', title: '领&nbsp;&nbsp;队', orderable: true }, { data: 'updated_at', title: '发布日期', orderable: true }, { data: 'deadline', title: '要求完成日期', orderable: true }]
      });
