  ...
  function getUsers() {
    service.getUsers(bID, function (res) {
      ...
      $('#accountTable1').dataTable({
        ...
        data: res,
        columns: [{ data: 'worker_number', title: '工号', orderable: false }, { data: 'name', title: '姓名', orderable: false }, { data: 'level', title: '等级', orderable: false }, { data: 'title', title: '岗位名称', orderable: false }, { data: 'grade', title: '岗位级别', orderable: false }, { data: 'role_id2', title: '帮会职务', orderable: false }, { data: 'year_of_service', title: '从业时长', orderable: false }]
      });
