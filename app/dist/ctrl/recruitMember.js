  ...
  function getList() {
    service.getList(getUrlParam('exclude'), function (res) {
      ...
      $('#accountTable1').dataTable({
        ...
        data: res,
        columns: [{ data: 'worker_number', title: '工号', orderable: true }, { data: 'name', title: '姓名', orderable: true }, { data: 'level2', title: '等级', orderable: true }, { data: 'title', title: '岗位名称', orderable: true }, { data: 'grade', title: '岗位级别', orderable: true }, { data: 'role_id2', title: '帮会职务', orderable: true }, { data: 'year_of_service', title: '从业时长', orderable: true }, { data: '_id', title: 'aaa', orderable: false }]
      });
