...
$(function () {
  ...
  var user_role = parseInt(window.sessionStorage.getItem('role_id'));
  ...
  function getTasks() {
    service.getTasks({ faction_id: faction_id, type: 1 }, function (res) {
      ...
      $('#accountTable1').dataTable({
        ...
        data: res,
        columns: [{ data: 'num', title: '序号', orderable: true }, { data: 'title', title: '任务名称', orderable: true }, { data: 'leader_grade', title: '最低岗位级别', orderable: true }, { data: 'base_vc', title: 'VC<!--</br>(单位:VC)-->', orderable: true }, { data: 'gold', title: '金币<!--</br>(单位:人民币)-->', orderable: true }, { data: 'exp', title: '经验值<!--</br>/验收人-->', orderable: true }, { data: 'subtype2', title: '任务类型', orderable: true }, { data: 'level', title: '任务等级', orderable: true }, { data: 'status2', title: '任务状态', orderable: true }, { data: 'created.name', title: '发布人', orderable: true }, { data: 'leader2', title: '领&nbsp;&nbsp;队', orderable: true }, { data: 'published_at', title: '发布日期', orderable: true }, { data: 'deadline', title: '要求完成日期', orderable: true }]
      });
