...
$(function () {
  ...
  function getList() {
    service.getList(obj, function (res) {
      ...
      $('#lmMember').dataTable({
        ...
        data: res,
        columns: [{ data: 'num', title: '序号', orderable: true }, { data: 'title', title: '标题', orderable: true }, { data: 'published_user', title: '发布人', orderable: true }, { data: 'created_at', title: '发布时间', orderable: true }, { data: 'btn', title: '', orderable: false }]
      });
  ...
  $(".deleteBtn").click(function () {
    ...
    if ($(".pitch.his_active").length === 0) {
      ...
      confirmAgain({
        ...
        btns: [{ domId: 'cancel', text: '取消' }, { domId: 'confirm', text: '确定', event: confirmDelete }]
      });
    }
  });
  function confirmDelete() {
    ...
    service.delete(ids, function (res) {
      getList();
    });
  }
