  ...
  function getList() {
    service.getList(function (res) {
      ...
      $('#meeting').dataTable({
        ...
        data: res,
        columns: [{ data: 'num', title: '序号', orderable: true }, { data: 'title', title: '标题', orderable: true }, { data: 'user.name', title: '发布人', orderable: true }, { data: 'created_at', title: '发布时间', orderable: true }, { data: 'btn', title: '', orderable: false }]
      });
