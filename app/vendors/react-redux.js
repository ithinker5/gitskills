...
/***/ function(module, exports, __webpack_require__) {
	...
	/*
	  ...
	  selector, otherwise the Connect ui will re-render on every state or props change.
	*/
	selectorFactory) {
	  ...
	  return function wrapWithConnect(WrappedComponent) {
	    (0, _invariant2.default)(typeof WrappedComponent == 'function', 'You must pass a ui to the function returned by ' + ('connect. Instead received ' + WrappedComponent));
	    ...
	    var Connect = function (_Component) {
	      ...
	      function Connect(props, context) {
	        ...
	        (0, _invariant2.default)(_this.store, 'Could not find "' + storeKey + '" in either the context or ' + ('props of "' + displayName + '". ') + 'Either wrap the root ui in a <Provider>, ' + ('or explicitly pass "' + storeKey + '" as a prop to "' + displayName + '".'));
	      ...
	      Connect.prototype.componentDidMount = function componentDidMount() {
	        ...
	        // To handle the case where a child ui may have triggered a state change by
	      ...
	      Connect.prototype.addExtraProps = function addExtraProps(props) {
	        ...
	        // this is especially important for 'ref' since that's a reference back to the ui
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 
	// A length of one signals that mapToProps does not depend on props from the parent ui.
...
/***/ function(module, exports) {
	...
	// encapsulates the subscription logic for connecting a ui to the redux store, as
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*
	  ...
	  selectorFactory each time a Connect ui instance is instantiated or hot reloaded.

	  selectorFactory returns a final props selector from its mapStateToProps,
	  mapStateToPropsFactories, mapDispatchToProps, mapDispatchToPropsFactories, mergeProps,
	  mergePropsFactories, and pure args.

	  The resulting final props selector is called by the Connect ui instance whenever
	...
	function match(arg, factories, name) {
	  ...
	  return function (dispatch, options) {
	    throw new Error('Invalid value of type ' + typeof arg + ' for ' + name + ' argument when connecting ui ' + options.wrappedComponentName + '.');
	  };
	}
	...
	function createConnect() {
	  ...
	  return function connect(mapStateToProps, mapDispatchToProps, mergeProps) {
	    ...
	    return connectHOC(selectorFactory, _extends({
	      ...
	      // used to compute Connect's displayName from the wrapped ui's displayName.
	      getDisplayName: function getDisplayName(name) {
	        return 'Connect(' + name + ')';
	      },

	      // if mapStateToProps is falsy, the Connect ui doesn't subscribe to store state changes
